...
The temperature data does not have constant update time, to have it better align with the Demand data, we 
...
ggplot(sampled_df_max2, aes(x = DATETIME)) + 
  ...
  geom_point(aes(y = FORECASTDEMAND, color = "Forecast Demand"), size = 2, alpha = 0.5) + 
  geom_point(aes(y = TOTALDEMAND, color = "Total Demand"), size = 2, alpha = 0.5) +
  labs(title = "Benchmark Forecast (Shifted Time) vs Total Demand on Random Days in 2017",
       x = "Hour of the Day",
       y = "Demand",
       color = "Legend") +
  scale_color_manual(values = c("Forecast Demand" = "red", "Total Demand" = "blue")) +
...
## Final Model - SARIMA_212210[48] with Weekly Fourier and Temperature
