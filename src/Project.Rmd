...
# Initialize vectors to store forecasts and actual values for 48 steps
forecasts <- numeric(5)
actuals <- numeric(5)

for (i in 1:5) {  # Loop 48 times for the 24-hour period
  # Define the current training set up to the point of forecasting
...
results_df <- data.frame(Time = 1:5, Forecast = forecasts, Actual = actuals)
